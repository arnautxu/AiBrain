...
| Documents and browser | Isolated document preview/publication boundaries and approval-aware browser effects are implemented | One approved real Arnall action with controlling-system readback; no synthetic substitute |
