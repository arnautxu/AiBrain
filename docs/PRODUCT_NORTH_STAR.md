...
4. **Governed effects:** documents, browser actions, connectors and automations are authorized server-side, bind approval to the exact actor/target/version and return controlling-system readback.
