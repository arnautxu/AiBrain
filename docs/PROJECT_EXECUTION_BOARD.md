...
| Release-coordination worktree | validated locally | `/Users/davidliria/Documents/AiBrain-release-coordination`, branch `codex/aibrain-release-coordination`, base `390bbb06c1dac491b89b3c2a133713c6439584bb`; `git diff --check` and local-link inspection passed | Commit this governance-only unit locally; no push |
...
| --- | --- | --- | --- | --- |
| G0 | Governance documents only; release coordinator | validated locally | This file, [definition of done](DEFINITION_OF_DONE.md), and [release runbook](RELEASE_AND_ACCEPTANCE_RUNBOOK.md); clean diff check and existing local targets | Commit locally; do not push |
