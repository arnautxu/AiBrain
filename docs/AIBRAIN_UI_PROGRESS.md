...
| 2. Tokens, primitivas, white-label, tipografía, tema, responsive | En curso | — |
| 3. Login, shell, sidebar, navegación, proyectos, búsqueda, mobile | Pendiente | — |
...
Implementar los tokens semánticos, primitivas, proyección pública de InstallationConfig, tipografía, iconos, temas light/dark/system y la estructura responsive del checkpoint 2.
