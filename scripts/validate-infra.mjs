...
requireMatch(arnallDeployGateway, /validate_release_secret_contract\n[\s\S]{0,160}require_release_readback_runtime/u, "Arnall deploy gateway does not fail fast on the release secret contract");
