              ...
              {activeProjects.length === 0 ? (
                ...
                return (
                  <SidebarMenuItem key={project.id} className="group/project">
                    ...
                    {projectThreadsOpen ? <div aria-label={`Chats de ${project.name}`} className="ml-5 pl-1">
