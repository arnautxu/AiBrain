...
export function ToolCall({ result, onOpenBrowser }: {
  result: ToolResult;
  onOpenBrowser?: () => void;
}) {
  ...
  return (
    <details data-slot="tool-call" className="group/tool overflow-hidden rounded-[12px] border border-[var(--border)] bg-[var(--surface-raised)]">
