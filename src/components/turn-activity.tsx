...
const SYSTEM_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "Connectant amb Codex": "Conectando con Codex",
  "Codex connectat": "Codex conectado",
  ...
  "Codex està treballant": "Codex está trabajando",
  "Preparant el resum del raonament": "Preparando el resumen del razonamiento",
  "Codex està raonant": "Codex está razonando",
