...
export function CustomizationPanel({ productName, open, initialTab = "appearance", runtimeStatus, projects = [], threads = [], archiveBusy = false, onRestoreProject, onRestoreThread, onSettingsSnapshot, onOpenMemory, onClose }: Props) {
