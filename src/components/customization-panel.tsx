...
function connectorServices(id: string, label: string) {
  ...
  if (normalized.includes("google")) return ["Gmail", "Google Calendar", "Google Drive"];
  if (normalized.includes("microsoft") || normalized.includes("office")) return ["Outlook", "Microsoft Calendar", "OneDrive"];
