  ...
  return (
    <div className="relative inline-block">
      <style>{`
        ...
        .rg-button:not(:disabled):is(:hover, :focus-visible) {
          --rg-pos-x: 0%;
          --rg-pos-y: 120%;
          --rg-spread-x: 110.24%;
          --rg-spread-y: 110.2%;
        ...
        .rg-button:focus-visible { outline: 2px solid var(--focus); outline-offset: 3px; }
        .rg-button .rg-shine span, .rg-button .rg-shine span::before { animation-play-state: paused; }
        .rg-button:not(:disabled):is(:hover, :focus-visible) .rg-shine span,
        .rg-button:not(:disabled):is(:hover, :focus-visible) .rg-shine span::before { animation-play-state: running; }
        @media (prefers-reduced-motion: reduce) {
          .rg-button, .rg-button * { transition: none !important; }
