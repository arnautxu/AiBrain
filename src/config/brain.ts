...
export const baseBrainManifest: BrainManifest = {
  ...
  interface: {
    ...
    welcomeMessage:
      "Converteix una idea en feina verificable, segueix el pla en directe i revisa cada canvi abans que s’executi.",
    accent: "graphite",
    density: "comfortable",
    corners: "soft",
    showInspector: true,
...
export const operationsBrainManifest: BrainManifest = {
  ...
  interface: {
    ...
    welcomeMessage:
      "Coordina incidències, automatitzacions i canvis operatius amb traçabilitat i aprovacions explícites.",
    accent: "blue",
    density: "compact",
    corners: "precise",
    showInspector: true,
